...
#Previous query converted into a stored procedure.
DELIMITER //
...
#Previous query converted into a stored procedure that takes the input for store_id and displays the total sales for that store.
DELIMITER //
...
#Previous query updated with a variable total_sales_value of float type
DELIMITER //
